...
namespace ITI.PrimarySchool.WebApp.Controllers
{
    ...
    public class TeacherController : Controller
    {
        ...
        {
            Result<Teacher> result = _teacherService.CreateTeacher( model.FirstName, model.LastName, model.IsHere );
            return this.CreateResult<Teacher, TeacherViewModel>( result, o =>
            {
                o.ToViewModel = t => t.ToTeacherViewModel();
        ...
        {
            Result<Teacher> result = _teacherService.UpdateTeacher( id, model.FirstName, model.LastName, model.IsHere);
            return this.CreateResult<Teacher, TeacherViewModel>( result, o =>
            {
                o.ToViewModel = t => t.ToTeacherViewModel();
            } );
        ...
        {
            Result<IEnumerable<Teacher>> result = _teacherService.GetByClassId(classId);
            return this.CreateResult<IEnumerable<Teacher>, IEnumerable<TeacherViewModel>>(result, o =>
            {
                o.ToViewModel = x => x.Select(t => t.ToTeacherViewModel());
            });
