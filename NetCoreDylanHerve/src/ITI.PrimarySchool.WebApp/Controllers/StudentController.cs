...
namespace ITI.PrimarySchool.WebApp.Controllers
{
    ...
    public class StudentController : Controller
    {
        ...
        {
            Result<Student> result = _studentService.CreateStudent( model.FirstName, model.LastName, model.BirthDate, model.Photo, model.GitHubLogin, model.Classe);
            return this.CreateResult<Student, StudentViewModel>( result, o =>
            {
                o.ToViewModel = s => s.ToStudentViewModel();
        ...
        {
            Result<Student> result = _studentService.UpdateStudent( id, model.FirstName, model.LastName, model.BirthDate, model.Photo, model.GitHubLogin, model.Classe);
            return this.CreateResult<Student, StudentViewModel>( result, o =>
            {
                o.ToViewModel = s => s.ToStudentViewModel();
            } );
        ...
        public IActionResult GetStudentByClass(int classId)
        {
           Result<IEnumerable<Student>> result = _studentService.GetByClassId(classId);
            return this.CreateResult<IEnumerable<Student>, IEnumerable<StudentViewModel>>(result, o =>
            {
                o.ToViewModel = x => x.Select(s => s.ToStudentViewModel());
            });
        ...
        {
            Result<IEnumerable<Student>> result = _studentService.FilterName(name);
            return this.CreateResult<IEnumerable<Student>, IEnumerable<StudentViewModel>>(result, o =>
            {
                o.ToViewModel = x => x.Select(s => s.ToStudentViewModel());
            });
