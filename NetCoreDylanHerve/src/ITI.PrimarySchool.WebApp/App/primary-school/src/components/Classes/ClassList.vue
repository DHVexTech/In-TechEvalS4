<template>
    <div>
        ...
        <span v-if='message == "Classe Supprimée"'><alert color="green" :message="message"></alert></span>   
        ...
        <table class="table table-striped table-hover table-bordered">
            ...
            <tbody>
                ...
                <tr v-for="i of classList">
                    <td>{{ i.classId }}</td>
                    <td><router-link :to="`classes/view/${i.classId}`"><i>{{ i.name }}</i></router-link></td>
                    <td>{{ i.level }}</td>
                    <td>
