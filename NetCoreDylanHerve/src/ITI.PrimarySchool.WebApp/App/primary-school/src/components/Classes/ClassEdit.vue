<template>
    <div>
        ...
        <span v-if='alertError != null'><alert color="red" :message="alertError"></alert></span>
        ...
        async mounted() {
            ...
            if(this.mode == 'edit') {
                ...
                try {
                    ...
                    //this.teacher = await TeacherApiService.getTeacherByClass(this.id);
                    //this.student = await StudentApiService.getStudentByClass(this.id);
                }
                catch(error) {
            ...
            async onSubmit(e) {
                ...
                if(errors.length == 0) {
                    try {
                        ...
                        this.notifyError(error);
                        this.alertError = "Verifiez les infos saisies.";
                    }
                    finally {
                        this.notifyLoading(false);
                    }
